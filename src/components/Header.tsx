    ...
    <header className="border-b border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-950/80 backdrop-blur-sm sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-1 text-sm font-medium">
          ...
          <Link href="/calculator" className="px-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
            Calculator
          </Link>
          <Link href="/codes" className="px-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
            Codes
          </Link>
          <Link href="/beginner-guide" className="px-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
            Guide
          </Link>
          <Link href="/updates" className="px-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
            Updates
          </Link>
          <Link href="/wiki" className="px-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
            Wiki
          </Link>
          <Link href="/tips" className="px-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
            Tips
          </Link>
        </nav>
      </div>
